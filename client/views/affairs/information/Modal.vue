<template>
  <card-modal :modalType="modalType" :visible="visible" @cancel="cancel" @ok="ok" :modalConfig="modalConfig" transition="zoom">
    ...
    <my-tabs v-if="modalConfig.add"></my-tabs>

    <ue v-if="modalConfig.test"></ue>
    
    <div class="map-container" v-if="modalConfig.modify">
      ...
      <div class="map-content">
        <zone-map :centerPoint="centerPoint"></zone-map>
      </div>
    </div>
