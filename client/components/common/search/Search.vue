<template>
  <div class="search" v-if="searchConfig.id">
    <ul class="content">
      <li v-if="searchConfig.id" class="item text">
        <input class="input is-primary" v-model="params.id" @keyup.enter="search()" placeholder="用户名"/>
      </li>
      <li v-if="searchConfig.userName" class="item text">
        <input class="input is-primary" v-model="params.userName" @keyup.enter="search()" placeholder="姓名"/>
      </li>
