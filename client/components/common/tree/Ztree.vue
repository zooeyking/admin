<template>
	<!--（ztree－🌲）-->
	<div class="tile is-parent" v-if='treeDataSource.length>0'>
		<article class="tile is-child box">
			...
			<ul class="ztree">
				<ztree-item v-for='(m,i) in treeDataSource' :key='i' :model="m" :num='i' root='0' :nodes='treeDataSource.length' :callback='func' :expandfunc='expand' :cxtmenufunc='contextmenu' :trees='treeDataSource' @remove="remove"></ztree-item>
			</ul>
		</article>
	</div>
</template>
        ...
        ztreeItem:{
            ...
            `<li>
				...
				<ul :class="ulClassVal" v-show='model.isFolder'>
					<ztree-item v-for="(item,i) in model.children" :key='i' :callback='callback' :expandfunc='expandfunc' :cxtmenufunc='cxtmenufunc' :model="item" :num='i' root='1' :nodes='model.children.length' :trees='trees' @remove="remove"></ztree-item>
				</ul>
			</li>`
		}
	},
